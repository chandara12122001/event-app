                    ...
                    <div class=" sm:p-16 sm:px-28 p-10">
                        <div class="flex flex-col space-y-5">
                            ...
                            <div class="flex flex-row justify-between items-center">
                                ...
                                <div>
                                    <div class="cursor-pointer border border-orange-400 bg-orange-400 p-2 sm:px-16 rounded-md hover:border-orange-400 hover:bg-transparent hover:text-orange-400 hover:cursor-pointer">
                                        <p>Learn more</p>
                                    </div>
                                </div>
                            </div>
