...
<<<<<<< HEAD
@section('content')
    <div class="py-10 sm:px-36 px-14">
              ...
              <div class="flex sm:flex-row flex-col w-full items-center justify-center h-full">
                ...
                <div class="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
                  <form>
                    ...
                    <div class="flex sm:flex-row justify-between items-center mb-6 w-full text-sm">
                      <div class="form-group form-check flex-col items-center justify-center">
                        <input
                          type="checkbox"
...
>>>>>>> 49a0afb9198269de444dd7fefc39371d1fe01f2f
              </div>
