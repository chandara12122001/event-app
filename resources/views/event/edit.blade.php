...
@endphp
@section('content')
    <div class="w-full flex flex-col space-y-5 items-center justify-center py-5">
        <div>
            @foreach ($event->images as $image)
                <div class="flex flex-row space-x-5 items-start justify-center">
                    <div>
